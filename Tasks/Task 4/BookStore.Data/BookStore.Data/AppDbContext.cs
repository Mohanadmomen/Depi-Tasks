...
namespace BookStore.Data
{
    public class AppDbContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                // Try to read connection string from configuration, or fallback to the seed/development database server
                var connStr = _configuration?.GetConnectionString("DefaultConnection") 
                    ?? "Server=DESKTOP-MM542JE;Database=BookStoreEFCoreDB;Trusted_Connection=True;TrustServerCertificate=True;MultipleActiveResultSets=true";
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            { 
                ...
                City = "Cairo", 
                Role = "Customer",
                PasswordHash = "AQAAAAIAAYagAAAAEEp5aV9SFbq6iLagOQ8mh+0Jurtjb7OvMIKiEnwNXDQkVDyb90MxAaI4jtHvk5kTEA=="
            };
            ...
            modelBuilder.Entity<Customer>().HasData(ahmed, admin);
        }
    }
}